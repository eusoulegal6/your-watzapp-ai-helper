...
const FinalCTASection = () => {
  return (
    <section id="final-cta" className="py-24 md:py-32 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-wa-green/10 via-transparent to-transparent" />
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
            Install the extension, set up your business context, and let AI handle your repetitive WhatsApp chats. Takes two minutes.
          </p>
